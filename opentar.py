...
<title>~akkzilla/python-snippets/maintrunk : contents of tarfile/opentar.py at revision 100</title>
...
/<a href="/~akkzilla/python-snippets/maintrunk/files/100/tarfile">tarfile</a>/opentar.py
...
<li>
<a href="/~akkzilla/python-snippets/maintrunk/annotate/head:/tarfile/opentar.py">view with revision information</a>
</li>
...
<li>
<a href="/~akkzilla/python-snippets/maintrunk/changes?filter_file_id=opentar.py-20100329001919-xdy2jmy92rifwgoz-3">view changes to this file</a>
</li>
<li id="last">
<a href="/~akkzilla/python-snippets/maintrunk/download/head:/opentar.py-20100329001919-xdy2jmy92rifwgoz-3/opentar.py">download file</a>
</li>
</ul>
<div class="view">
<table id="logentries">
...
<span class="pyg-c"># [SNIPPET_NAME: Open a tar file]</span>
<span class="pyg-c"># [SNIPPET_CATEGORIES: tarfile]</span>
<span class="pyg-c"># [SNIPPET_DESCRIPTION: Open&#39;s a tar file and list the entries]</span>
...
<span class="pyg-k">print</span> <span class="pyg-s">&#39;about to open </span><span class="pyg-si">%s</span><span class="pyg-s">&#39;</span> <span class="pyg-o">%</span> <span class="pyg-n">filename</span>
<span class="pyg-n">mode</span> <span class="pyg-o">=</span> <span class="pyg-s">&#39;r:gz&#39;</span>

<span class="pyg-k">if</span> <span class="pyg-n">os</span><span class="pyg-o">.</span><span class="pyg-n">path</span><span class="pyg-o">.</span><span class="pyg-n">isfile</span><span class="pyg-p">(</span> <span class="pyg-n">filename</span> <span class="pyg-p">)</span> <span class="pyg-ow">and</span> <span class="pyg-n">tarfile</span><span class="pyg-o">.</span><span class="pyg-n">is_tarfile</span><span class="pyg-p">(</span> <span class="pyg-n">filename</span> <span class="pyg-p">):</span>
    <span class="pyg-n">tf</span> <span class="pyg-o">=</span> <span class="pyg-n">tarfile</span><span class="pyg-o">.</span><span class="pyg-n">open</span><span class="pyg-p">(</span> <span class="pyg-n">filename</span><span class="pyg-p">,</span> <span class="pyg-n">mode</span> <span class="pyg-p">)</span>
    <span class="pyg-n">tf</span><span class="pyg-o">.</span><span class="pyg-n">list</span><span class="pyg-p">()</span>
    <span class="pyg-n">tf</span><span class="pyg-o">.</span><span class="pyg-n">close</span><span class="pyg-p">()</span>
</pre>
</td>
</tr>
</table>
